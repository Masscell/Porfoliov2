const projects = [
  {
    ...
    category: "Product",
    description: "A fully functional beauty spa website showcasing services with responsive design and smooth interactions. Built with modern frontend technologies and animation libraries.",
  ...
  },
  {
    ...
    category: "AI",
    description: "Deep learning application using RESNET and VGGNET architectures to detect cervical cancer from medical imaging data with high accuracy.",
  ...
  },
  {
    ...
    category: "Product",
    description: "A professional hotel landing page showcasing amenities and booking features. Built with semantic HTML, modern CSS styling, and interactive JavaScript.",
  ...
  },
  {
    ...
    category: "Product",
    description: "A custom portfolio website showcasing design work and creative services with premium presentation and smooth user experience.",
  ...
  },
  {
    ...
    category: "Product",
    description: "A creative portfolio website showcasing digital services and creative work. Designed with modern web technologies and attention to visual hierarchy.",
...
const filters = ["All", "Product", "AI", "Systems", "Commerce"];
export {
  filters as f,
  projects as p
};
