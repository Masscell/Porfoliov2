const projects = [
  {
    ...
    title: "Orbit Command",
    category: "Product",
    description: "A real-time operations dashboard for distributed teams, blending command palette workflows with deeply instrumented product telemetry.",
  ...
  },
  {
    ...
    title: "Neural Market",
    category: "AI",
    description: "An AI-assisted ecommerce studio that converts merchandising intent into launch-ready pages, offers, and localized campaign variants.",
  ...
  },
  {
    ...
    title: "Atlas Labs",
    category: "Systems",
    description: "A cinematic documentation and analytics layer for infrastructure teams managing deployments across regions and runtime providers.",
  ...
  },
  {
    ...
    title: "Luma Checkout",
    category: "Commerce",
    description: "A premium checkout rebuild focused on trust, speed, and low-friction recovery paths across mobile and desktop purchase flows.",
